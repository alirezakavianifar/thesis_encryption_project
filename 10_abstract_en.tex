...
\textbf{Results:} Security analysis results indicate that the information entropy of the encrypted images reached an average of 7.9995 bits, and the correlation between adjacent pixels was reduced to less than 0.005. Furthermore, the NPCR and UACI values were calculated as 99.62\% and 33.48\%, respectively, demonstrating high resistance against various attacks. The execution time for 512 × 512 images is approximately 2.99 seconds.
