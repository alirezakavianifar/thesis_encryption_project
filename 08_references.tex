...
\bibitem{ref11} \RL{صادقیان، سعیده (۱۴۰۰). رمزنگاری تصویر مبتنی بر آشوب با ترکیب الگوریتم بهینه سازی ذرات و الگوریتم ژنتیک. هشتمین کنگره ملی تازه های مهندسی برق و کامپیوتر ایران، تهران.}
...
\bibitem{ref14} Chen, D., Zhu, Z., \& Yang, G. (2008). An improved image encryption algorithm based on chaos. \textit{The 9th International Conference for Young Computer Scientists}, 2792-2796.
...
\bibitem{ref20} Strogatz, S. H., \& Herbert, D. E. (1996). Nonlinear dynamics and chaos. \textit{Medical Physics}, 23(6), 993-995.
...
\bibitem{ref24} Mandelbrot, B. B. (1977). \textit{The fractal geometry of nature}. Vol. 1. New York: WH Freeman.
...
\bibitem{ref26} \RL{الوانی، سید مهدی و دانایی فرد، حسن (۱۳۸۴). تئوری نظم در بینظمی و مدیریت. تهران: انتشارات صفار.}
...
\bibitem{ref30} Liu, Z. J., Dai, J. M., Sun, X. G., \& Liu, S. T. (2010). Color image encryption by using the rotation of color vector in Hartley transform domains. \textit{Opt Lasers Eng}, 48(7), 800-5.

\bibitem{ref31} Chen, T. H., Tsao, K. H., \& Lee, Y. S. (2012). Yet another multiple-image encryption by rotating random grids. \textit{Signal Process}, 92(9), 2229-37.

\bibitem{ref32} Enayatifar, R., Sadaei, H. J., Abdullah, A. H., Lee, M., \& Isnin, I. F. (2015). A novel chaotic based image encryption using a hybrid model of DNA and cellular automata. \textit{Opt Lasers Eng}, 71, 33-41.

\bibitem{ref33} Xiao, G. Z., Lu, M. X., Qin, L., \& Lai, X. J. (2006). New field of cryptography: DNA cryptography. \textit{Chin Sci Bull}, 51(12), 1413-20.

\bibitem{ref34} Huang, R., Rhee, K. H., \& Uchida, S. (2014). A parallel image encryption method based on compressive sensing. \textit{Multimed Tools Appl}, 72(1), 71-93.

\bibitem{ref35} Zhou, N. R., Zhang, A. D., Zheng, F., \& Gong, L. H. (2014). Novel image compression-encryption hybrid algorithm based on key-controlled measurement matrix. \textit{Opt Laser Technol}, 62, 152-60.

\bibitem{ref36} Matthews, R. (1989). On the derivation of a chaotic encryption algorithm. \textit{Cryptologia}, 13(1), 29-42.

\bibitem{ref37} Wang, X. Y., Teng, L., \& Qin, X. (2012). A novel colour image encryption algorithm based on chaos. \textit{Signal Process}, 92(4), 1101-8.
...
\bibitem{ref39} Nanrun, Z., Pan, S., Cheng, S., \& Zhou, Z. (2016). Image compression-encryption scheme based on hyper-chaotic system and 2D compressive sensing. \textit{Optics \& Laser Technology}, 82, 121-133.
...
\bibitem{ref44} Yueping, L., Wang, C., \& Chen, H. (2017). A hyper-chaos-based image encryption algorithm using pixel-level permutation and bit-level permutation. \textit{Optics and Lasers in Engineering}, 90, 238-246.

\bibitem{ref45} Leyuan, W., Song, H., \& Liu, P. (2016). A novel hybrid color image encryption algorithm using two complex chaotic systems. \textit{Optics and Lasers in Engineering}, 77, 118-125.
