...
You can run the code cell-by-cell in VS Code using the interactive Python version:
1. Open `thesis_latex_source/thesis_appendix.py` in VS Code.
2. Ensure the **Python** and **Jupyter** extensions are installed.
3. Click **Run Cell** (or press `Shift+Enter`) above any code cell (demarcated by `# %%`).
