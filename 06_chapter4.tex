...
\section{تحلیل بصری خروجی‌های رمزنگاری\protect\LTRfootnote{Visual Analysis of Encryption Outputs}}
...
\section{تحلیل آنتروپی\protect\LTRfootnote{Entropy Analysis}}
آنتروپی شانون\protect\LTRfootnote{Shannon Entropy} یکی از مهم‌ترین شاخص‌ها برای ارزیابی میزان تصادفی بودن توزیع مقادیر در یک تصویر رمزشده است. برای یک منبع اطلاعاتی $m$، آنتروپی از رابطه زیر محاسبه می‌شود:
...
\subsection{مقادیر آنتروپی\protect\LTRfootnote{Entropy Values}}
...
\section{تحلیل همبستگی پیکسل‌های مجاور\protect\LTRfootnote{Adjacent Pixel Correlation Analysis}}
...
\subsection{ضریب همبستگی کلی\protect\LTRfootnote{Overall Correlation Coefficient} (10000 جفت تصادفی)}
...
\lr{Tree} & $\sim 0/96$ & $0/0047$ & $99/51$\% \\ \hline
\lr{Peppers} & $\sim 0/97$ & $0/0083$ & $99/14$\% \\ \hline
\lr{Baboon} & $\sim 0/94$ & $0/0034$ & $99/64$\% \\ \hline
\lr{Airplane} & $\sim 0/91$ & $-0/0035$ & $100/38$\% \\ \hline
\end{tabular}
\end{table}
...
حساسیت الگوریتم رمزنگاری به تغییرات کوچک در تصویر اصلی با استفاده از دو شاخص نرخ تغییر تعداد پیکسل‌ها (\lr{NPCR}\protect\LTRfootnote{Number of Pixels Change Rate}) و میانگین شدت تغییرات یکنواخت (\lr{UACI}\protect\LTRfootnote{Unified Averaged Changed Intensity}) سنجیده می‌شود.
...
\section{تحلیل جامع زمان اجرا\protect\LTRfootnote{Comprehensive Execution Time Analysis}}
\subsection{زمان اجرا\protect\LTRfootnote{Execution Time} (ثانیه)}
...
در این آزمایش، نویز نمک و فلفل\protect\LTRfootnote{Salt \& Pepper Noise} با چگالی‌های مختلف (0.01 تا 0.05) به تصویر رمزشده اضافه گردید. نتایج نشان داد که به دلیل مکانیزم انتشار دینامیک مبتنی بر 9 سیستم آشوبی، تأثیر نویز در سطح کل تصویر پخش شده و پس از رمزگشایی، ساختار اصلی تصویر با \lr{PSNR} قابل قبول همچنان قابل تشخیص است.
...
\section{ارزیابی مقایسه‌ای با سایر روش‌ها\protect\LTRfootnote{Comparative Evaluation with Other Methods}}
...
\section{نتیجه‌گیری فصل\protect\LTRfootnote{Chapter Conclusion}}
