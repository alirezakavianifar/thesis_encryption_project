...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.31\textwidth}
        ...
        \caption{تصویر اصلی درخت (\lr{Tree})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image12}
        \caption{تصویر رمزشده درخت (\lr{Tree})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image11}
        \caption{تصویر رمزگشایی‌شده درخت (\lr{Tree})}
    \end{subfigure}
    ...
    \begin{subfigure}{0.31\textwidth}
        ...
        \caption{تصویر اصلی فلفل‌ها (\lr{Peppers})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image14}
        \caption{تصویر رمزشده فلفل‌ها (\lr{Peppers})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image13}
        \caption{تصویر رمزگشایی‌شده فلفل‌ها (\lr{Peppers})}
    \end{subfigure}
    ...
    \begin{subfigure}{0.31\textwidth}
        ...
        \caption{تصویر اصلی بابون (\lr{Baboon})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image16}
        \caption{تصویر رمزشده بابون (\lr{Baboon})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image15}
        \caption{تصویر رمزگشایی‌شده بابون (\lr{Baboon})}
    \end{subfigure}
    ...
    \begin{subfigure}{0.31\textwidth}
        ...
        \caption{تصویر اصلی هواپیما (\lr{Airplane})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image18}
        \caption{تصویر رمزشده هواپیما (\lr{Airplane})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image17}
        \caption{تصویر رمزگشایی‌شده هواپیما (\lr{Airplane})}
    \end{subfigure}

    \caption{نتایج بصری رمزنگاری و رمزگشایی تصاویر آزمایشی استاندارد} \label{fig:visual_results}
\end{figure}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{توزیع هیستوگرام تصویر درخت (\lr{Tree})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image20}
        \caption{توزیع هیستوگرام تصویر فلفل‌ها (\lr{Peppers})}
    \end{subfigure}
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{توزیع هیستوگرام تصویر بابون (\lr{Baboon})}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{vertopal_6a6e478acc1947c1bfecfac3523ed62b/media/image22}
        \caption{توزیع هیستوگرام تصویر هواپیما (\lr{Airplane})}
    \end{subfigure}
    \caption{تحلیل هیستوگرام تصاویر اصلی و رمزشده برای ارزیابی یکنواختی} \label{fig:histogram_analysis}
\end{figure}
