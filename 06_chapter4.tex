...
از آنجا که فضای کلید محاسباتی الگوریتم پیشنهادی ($2^{1749}$ و در حالت محافظه‌کارانه $2^{636}$) به مراتب بزرگ‌تر از حد آستانه امنیتی $2^{128}$ است، الگوریتم پیشنهادی در برابر هرگونه حمله جستجوی فراگیر مقاومت بسیار بالایی نشان می‌دهد.
